  ...
  switch (company) {
	...
	case 'sendgrid':
	  return [
		...
		<Text>Maintain <Link to='https://itunes.apple.com/us/app/ardent-solve/id1334285655'>Ardent Solve</Link>, an iPad app allowing students to complete assignments; currently serving 400 students (Node.js, RethinkDB, REST, React Native)</Text>,
